...
import { editSection, shiftSection, switchOrder } from './Controllers/editsection.controller.js';
...
router.patch("/switch-order", isAuthenticated, authorizeRoles("admin"), switchOrder);
router.patch("/shift-section", isAuthenticated, authorizeRoles("admin"), shiftSection);
