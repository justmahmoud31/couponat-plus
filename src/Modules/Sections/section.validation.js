...
export const sectionValidation = Joi.object({
    ...
    type: Joi.string()
        .valid("Slider", "BannerText", "Categories", "Coupons", "Events", "Marketing", "Stores", "TwoBanner", "Products")
        .required()
        .messages({
            "any.required": "Type is required",
            "any.only": "Type must be one of Slider, BannerText, Categories, Coupons, Events, Marketing, Stores, TwoBanner"
        }),
